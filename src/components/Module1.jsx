...
export default function Module1() {
    return (
        <div className="w-[90vw] border-2 border-[#ff6633] md:w-[75vw] h-[80vh] p-2 md:bg-slate-50 rounded-xl overflow-y-scroll">
            ...
            <p className="text-justify">A data structure is a way of organizing and storing data in a computer so that it can be accessed and manipulated efficiently. It provides a set of operations for performing common tasks on the data, such as inserting, deleting, searching, and sorting.</p>
            <h1 className="my-2 text-xl md:text-2xl text-justify">Type Of Data Structures:</h1>
            <ol className="list-decimal text-justify px-5">
            ...
            <ul className="list-disc my-2 text-justify px-5">
